...
export async function POST(req: NextRequest) {
    try {
        ...
        const r1Prompt = `${HAI_RONG_CHOI_PROMPT}\n\nINPUT: "${topic}"\n\nVIẾT BÀI NHÁP ĐẦU TIÊN (DRAFT 1):`;
